...
/**
 * Plugin implementation of the 'exo_linkit' widget.
 *
 * @FieldWidget(
 *   id = "exo_linkit",
 ...
 * )
 */
class ExoLinkit extends ExoLinkWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if (!$this->supportsExternalLinks()) {
      ...
      $element['uri']['#description'] = $this->t('This must be an internal path such as %add-node. You can also start typing the title of a piece of content to select it. Enter %front to link to the front page.', [
        '%add-node' => '/node/add',
        '%front' => '<front>',
      ]);
    }
