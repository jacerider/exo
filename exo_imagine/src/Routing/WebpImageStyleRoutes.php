 ...
 */
class WebpImageStyleRoutes implements ContainerInjectionInterface {
  ...
  public function routes() {
    ...
    $routes['image.webp.style_public'] = new Route(
      '/' . $directory_path . '/exowebp/styles/{image_style}/{scheme}',
      [
        '_controller' => 'Drupal\exo_imagine\Controller\WebpImageStyleDownloadController::deliver',
      ],
      [
        '_access' => 'TRUE',
      ]
