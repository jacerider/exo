...
class EntityList extends RenderElement {
  ...
  public static function preRenderExoEntityListViewElement($element) {
    ...
    if (isset($element['#filters_prefix']) || isset($element['#filters_suffix'])) {
      $element['list']['header']['#access'] = TRUE;
      $element['list']['header']['first']['#access'] = TRUE;
      $element['list']['header']['first']['filters']['#access'] = TRUE;
      $element['list']['header']['first']['filters']['inline']['#access'] = TRUE;
