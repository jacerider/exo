...
namespace Drupal\exo_list_builder_commerce\Plugin\Derivative;
 ...
 */
class CommercePluginItemDeriver extends DeriverBase implements ContainerDeriverInterface {
  ...
  public function getDerivativeDefinitions($base_plugin_definition) {
    ...
    foreach ($plugin_types as $plugin_type => $label) {
      $this->derivatives[$plugin_type] = [
        'commerce_plugin_type' => $plugin_type,
        'field_type' => ['commerce_plugin_item:' . $plugin_type],
