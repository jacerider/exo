 ...
 *
 * @see \Drupal\exo_asset\Entity\ExoAsset.
 */
class ExoAssetAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\exo_asset\Entity\ExoAssetInterface $entity */
    switch ($operation) {
      case 'view':
