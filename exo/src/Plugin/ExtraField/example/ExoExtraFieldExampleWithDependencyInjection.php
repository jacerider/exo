 ...
 * )
 */
class ExoExtraFieldExampleWithDependencyInjection extends ExoExtraFieldDisplayBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a ExoExtraFieldDisplayFormattedBase object.
   *
