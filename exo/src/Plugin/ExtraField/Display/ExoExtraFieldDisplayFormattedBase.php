 ...
 */
abstract class ExoExtraFieldDisplayFormattedBase extends ExoExtraFieldDisplayBase implements ExoExtraFieldDisplayFormattedInterface {
  ...
  public function getFieldName() {
    return 'exo_extra_field_' . $this->pluginId;
  }
