...
namespace Drupal\exo_link\Element;
 ...
 * @endcode
 *
 * @RenderElement("exo_link")
 */
class ExoLink extends RenderElement {
   ...
   */
  public static function preRenderLink(array $element) {
    ...
    if (!empty($element['#url']) && $element['#url'] instanceof CoreUrl) {
      // This is the only change compared to core Link element. The reason
      // for this is the mergeDeep has issues with: bla[52]=52.
