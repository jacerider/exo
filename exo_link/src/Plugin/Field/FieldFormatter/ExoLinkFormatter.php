...
namespace Drupal\exo_link\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'exo_link' formatter.
 *
 * @FieldFormatter(
 *   id = "exo_link",
 ...
 * )
 */
class ExoLinkFormatter extends LinkFormatter {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    foreach ($elements as $delta => &$element) {
      ...
      if ($icon_id) {
        ...
        $icon = $this->icon($element['#title'])->setIcon($icon_id);
        if ($position == 'after') {
          $icon->setIconAfter();
        }
        $element['#title'] = $icon;
