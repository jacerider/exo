...
namespace Drupal\exo_filter\Plugin\views\filter;
 ...
 *
 * @ViewsFilter("exo_filter_entity_reference")
 */
class ExoFilterEntityReference extends ManyToOne {
  ...
  public function buildExtraOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    if ($bundleType) {
      ...
      $form['sort'] = [
        '#type' => 'container',
        '#id' => 'exo-filter-entity-reference-sort',
      ];
      ...
      $form['sort']['field'] = [
        ...
        '#ajax' => [
          ...
          'wrapper' => 'exo-filter-entity-reference-sort',
        ],
